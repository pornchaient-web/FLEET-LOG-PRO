      ...
      {showInstallBanner && (
        <div className="fixed bottom-6 right-6 left-6 md:left-auto md:w-96 z-50 bg-slate-900/95 border border-teal-500/30 p-5 rounded-3xl shadow-2xl backdrop-blur-xl text-white flex flex-col gap-4 animate-in fade-in slide-in-from-bottom-5 duration-300">
          ...
          <div className="flex items-center gap-2.5 justify-end">
            ...
            <button
              onClick={handleInstallPWA}
              className="px-4 py-2.5 bg-gradient-to-r from-teal-500 to-indigo-500 hover:from-teal-500 hover:to-indigo-600 text-white rounded-xl text-xs font-bold transition-all shadow-lg shadow-teal-500/20 flex items-center gap-1.5 cursor-pointer"
            >
              <Download size={13} />
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="leading-relaxed text-slate-300">
                      แสดงว่าคุณเปิดแอปนี้ใน <span className="text-amber-300 font-bold font-sans font-medium">"โหมดไม่ระบุตัวตน" (Incognito Mode / Private Tab)</span> ของ Chrome ซึ่งระบบความปลอดภัยจะบล็อกไม่ให้ลงทะเบียนแอป (PWA) และบีบให้สร้างบุ๊กมาร์กทางลัดธรรมดาแทนครับ
                    </p>
                    ...
                    <ol className="list-decimal pl-4 mt-1 space-y-1 text-slate-300 font-medium">
                      ...
                      <li>กดปุ่มติดตั้งอีกครั้ง จะปรากฏหน้าต่าง <span className="text-emerald-400 font-bold">"ติดตั้งแอป" (Install App)</span> พร้อมโลโก้แอปอย่างสวยงามทันที!</li>
                    </ol>
                  </div>
                </div>
              </div>
                          ...
                          <div className="space-y-3.5 bg-white/5 p-4 rounded-2xl border border-white/5">
                            <div className="flex items-start gap-3">
                              ...
                              <div>
                                ...
                                <p className="text-slate-400 leading-relaxed mt-0.5">
                                  แตะไอคอน 3 จุด <MoreVertical size={13} className="inline text-slate-300 mx-0.5" /> ที่มุมบนขวา (สำหรับ Android) หรือด้านล่างสุด of เบราว์เซอร์
                                </p>
                              </div>
                            </div>
